...
/** Format a date as DD/MM/YY. Date-only ISO strings are parsed as-is to avoid
    ...
    <>
      ...
      <div className={styles.templateSection}>
        ...
        <table className={styles.templateTable}>
          <tbody>
            <tr><td>Date</td><td><strong>{fmtDate(comp.competition_date)}</strong>{comp.backup_date ? ` (backup: ${fmtDate(comp.backup_date)})` : ''}</td></tr>
      ...
      <div className={styles.templateFooter}>
        <p>Generated by DepthViz · {fmtDate(new Date().toISOString())}</p>
      </div>
    </>
  )
}
